      ...
      >
        ...
        <div className="space-y-6">
          <blockquote className="space-y-3">
            ...
            <footer className="text-sm text-[#666]">UWB Hacks 2026 · Track 2: Human Experience</footer>
          </blockquote>
        ...
        <div className="w-full max-w-[360px] space-y-6">
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: '#666' }}>
              {mode === 'login' ? 'Sign in to access your knowledge base' : 'Start building your second brain'}
            </p>
          </div>

          <div className="flex rounded-lg p-0.5" style={{ background: '#161616', border: '1px solid #222' }}>
            {(['login', 'register'] as const).map(m => (
              <button
                ...
                style={mode === m ? { background: '#222', color: '#fff' } : { color: '#555' }}
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {mode === 'register' && (
              <div className="space-y-1.5">
                <label className="block text-xs font-medium" style={{ color: '#888' }}>Full name</label>
                <input
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium" style={{ color: '#888' }}>Email</label>
              <input
                className="corp-input w-full"
                type="email"
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium" style={{ color: '#888' }}>Password</label>
            ...
            >
              {loading ? <Loader2 size={15} className="animate-spin" /> : mode === 'login' ? 'Sign in' : 'Create account'}
            </button>
          </form>

          <div className="rounded-lg px-3 py-2.5 space-y-0.5" style={{ background: '#141414', border: '1px solid #1f1f1f' }}>
            <p className="text-[11px] font-medium" style={{ color: '#555' }}>Demo credentials</p>
            <p className="text-[11px] font-mono" style={{ color: '#444' }}>demo@dory.md · demo123</p>
          </div>
        </div>
      </div>
    </div>
